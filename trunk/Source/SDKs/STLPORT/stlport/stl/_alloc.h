...
typedef node_alloc<eCryDefaultMalloc, _STLP_NODE_ALLOCATOR_THREADS, DEFAULT_POOL_SIZE> _Node_alloc;
#else
...
#ifdef CRY_MEMORY_ALLOCATOR
 #ifdef STLALLOCATOR_CLEANUP
  #undef STLALLOCATOR_CLEANUP
 #endif
#define STLALLOCATOR_CLEANUP { std::vector<int> go_go_go; go_go_go.get_allocator().cleanup(); }
#endif
