...
enum EMessageParallelFlags
{
	...
	eMPF_AfterSpawning       = 0x0010,
	eMPF_StateChange         = 0x0020,
	eMPF_DontAwake           = 0x0040, // not a critical message - don't wake up sending
};
...
struct INetNub
{
	...
	// Description:
	//    Add a file to the list of protected files
	virtual void AddProtectedFile( const char * filename ) = 0;
	// Description:
	//    Clear the protected file list
