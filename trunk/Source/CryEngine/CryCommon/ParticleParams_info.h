...
ENUM_INFO_BEGIN(EFeatureSelect)
	ENUM_ELEM_INFO(, FeatureSelect_Both)
	ENUM_ELEM_INFO(, FeatureSelect_If_True)
	ENUM_ELEM_INFO(, FeatureSelect_If_False)
ENUM_INFO_END(EFeatureSelect)
...
STRUCT_INFO_BEGIN(ParticleParams)
	...
	STRUCT_VAR_INFO(nTailSteps, TYPE_INFO(uint) ATTR_INFO(Min,0) ATTR_INFO(Max,16))
	...
	STRUCT_VAR_INFO(bCollideObjects, TYPE_INFO(bool))
	...
	STRUCT_VAR_INFO(bOnlyOutdoors, TYPE_INFO(bool))
	STRUCT_VAR_INFO(bOnlyAboveWater, TYPE_INFO(bool))
	STRUCT_VAR_INFO(bOnlyUnderWater, TYPE_INFO(bool))
	...
	STRUCT_VAR_INFO(eDX10, TYPE_INFO(EFeatureSelect))
	STRUCT_VAR_INFO(eGPUComputation, TYPE_INFO(EFeatureSelect))
	STRUCT_VAR_INFO(eMultiThread, TYPE_INFO(EFeatureSelect))
