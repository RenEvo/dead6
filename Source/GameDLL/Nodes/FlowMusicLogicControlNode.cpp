...
public:
	...
	{
		CMusicLogic *pMusicLogic = g_pGame->GetMusicLogic();
		...
		case eFE_Activate:
			{
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_SET_ALL))
				{
					...
					pMusicLogic->SetMusicEvent(MUSICEVENT_SET_AI, fAI);
					// Set Player
					float fPlayer = GetPortFloat(pActInfo, eIN_SET_PLAYER);
					pMusicLogic->SetMusicEvent(MUSICEVENT_SET_PLAYER, fPlayer);
					// Set Game
					float fGame = GetPortFloat(pActInfo, eIN_SET_GAME);
					pMusicLogic->SetMusicEvent(MUSICEVENT_SET_GAME, fGame);
					// Set Change
					float fChange = GetPortFloat(pActInfo, eIN_SET_CHANGE);
					pMusicLogic->SetMusicEvent(MUSICEVENT_SET_CHANGE, fChange);
				}
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_ADD_ALL))
				{
					// Set AI
					float fAI = GetPortFloat(pActInfo, eIN_SET_AI);
					pMusicLogic->SetMusicEvent(MUSICEVENT_ADD_AI, fAI);
					// Set Player
					float fPlayer = GetPortFloat(pActInfo, eIN_SET_PLAYER);
					pMusicLogic->SetMusicEvent(MUSICEVENT_ADD_PLAYER, fPlayer);
					// Set Game
					float fGame = GetPortFloat(pActInfo, eIN_SET_GAME);
					pMusicLogic->SetMusicEvent(MUSICEVENT_ADD_GAME, fGame);
					// Set Change
					float fChange = GetPortFloat(pActInfo, eIN_SET_CHANGE);
					pMusicLogic->SetMusicEvent(MUSICEVENT_ADD_CHANGE, fChange);
				}
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_SET_AI))
				{
					...
					pMusicLogic->SetMusicEvent(MUSICEVENT_SET_AI, fSet);
				}
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_ADD_AI))
				{
					...
					pMusicLogic->SetMusicEvent(MUSICEVENT_ADD_AI, fAdd);
				}
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_SET_PLAYER))
				{
					...
					pMusicLogic->SetMusicEvent(MUSICEVENT_SET_PLAYER, fSet);
				}
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_ADD_PLAYER))
				{
					...
					pMusicLogic->SetMusicEvent(MUSICEVENT_ADD_PLAYER, fAdd);
				}
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_SET_GAME))
				{
					...
					pMusicLogic->SetMusicEvent(MUSICEVENT_SET_GAME, fSet);
				}
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_ADD_GAME))
				{
					...
					pMusicLogic->SetMusicEvent(MUSICEVENT_ADD_GAME, fAdd);
				}
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_SET_CHANGE))
				{
					...
					pMusicLogic->SetMusicEvent(MUSICEVENT_SET_CHANGE, fSet);
				}
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_ADD_CHANGE))
				{
					...
					pMusicLogic->SetMusicEvent(MUSICEVENT_ADD_CHANGE, fAdd);
				}
				...
				if (m_bEnable && IsPortActive(pActInfo, eIN_SET_MULTIPLIER))
				{
					...
					pMusicLogic->SetMusicEvent(MUSICEVENT_SET_MULTIPLIER, fMultiplier);
				}
		}
		break;
		}
