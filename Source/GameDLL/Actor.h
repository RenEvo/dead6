...
public:
	...
	{
		DropItemParams(): itemId(0), impulseScale(1.0f), selectNext(true) {};
		DropItemParams(EntityId item, float scale, bool next=true): itemId(item), impulseScale(scale), selectNext(next) {};
